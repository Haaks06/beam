...
// src/app.js, which added an object store in version 3 for a local
// received-items cache) throws. This file doesn't need that store itself,
// so its own upgrade logic only ever touches CONFIG_STORE.
const DB_VERSION = 3;
